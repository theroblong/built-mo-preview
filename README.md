...
- `mockups/mo_data_ops_customer.html` — customer-facing walkthrough for Brian and Connor; one card per module showing data required, data operations, and what Mo displays
- `mockups/mo_data_ops_kickoff.html` — technical reference for Rob and Jason; full Q-series and P-series pipeline stages with proper data tables
- `mockups/mo_data_ops_kickoff.pptx` — 8-slide kickoff deck (Title, Pipeline Overview, 5 module slides, Next Steps); generated by `scripts/mo_data_ops_kickoff_pptx.py`

Five modules documented: Cannibalization Risk, Price Elasticity, Promotional Response, Demand Velocity & Forecast, Distribution & Launch Monitoring. No version bump — documentation artifacts only, v2.5.6 unchanged.
